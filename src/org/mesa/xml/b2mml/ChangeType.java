 ...
 *         &lt;element name="PrechangeData" type="{http://www.mesa.org/xml/B2MML-V0600}ValueType" maxOccurs="unbounded"/>
 *         &lt;element name="Reason" type="{http://www.mesa.org/xml/B2MML-V0600}TextType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ChangeType {
    ...
    @XmlElement(name = "PrechangeData", required = true, nillable = true)
    protected List<ValueType> prechangeData;
    ...
    /**
     * Gets the value of the prechangeData property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the prechangeData property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPrechangeData().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ValueType> getPrechangeData() {
        if (prechangeData == null) {
            prechangeData = new ArrayList<ValueType>();
        }
